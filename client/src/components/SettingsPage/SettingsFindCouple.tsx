...
import { ISettingsFindCouple, ISettingsSavannah } from './settingsSlice';
...
interface Props {
  settings: ISettingsFindCouple;
  onChange: (nameSettings: string, settings: ISettingsFindCouple) => void;
}

export default function SettingsFindCouple({ settings, onChange }: Props) {
